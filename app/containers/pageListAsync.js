...
export const InterestQuestion = loadable(
  () => import('./StudentsSystem/InterestQuestion'),
  {
    fallback: <Loading />,
  }
);
...
export const RecommendInterest = loadable(
  () => import('./StudentsSystem/RecommendInterest'),
  {
    fallback: <Loading />,
  }
);
...
export const StudentFeedback = loadable(
  () => import('./StudentsSystem/StudentFeedback'),
  {
    fallback: <Loading />,
  }
);
